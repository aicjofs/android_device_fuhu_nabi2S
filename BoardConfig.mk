...
TARGET_BOOTLOADER_BOARD_NAME := nabi
TARGET_DEVICE := nabi2S
...
TARGET_PREBUILT_KERNEL := device/fuhu/nabi2S/kernel
TARGET_PREBUILT_RECOVERY_KERNEL := device/fuhu/nabi2S/kernel
